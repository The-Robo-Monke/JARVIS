...
bomb = pygame.image.load(path.join(assets, "bomb.png"))
...
font = pygame.font.Font(path.join(assets, "UniversLTStd-BoldEx.otf"), 18)

blockSurf = pygame.image.load(path.join(assets, "block.png")).convert()
blockSurfSel = pygame.image.load(path.join(assets, "selblock.png")).convert()
blockSurfBlank = pygame.image.load(path.join(assets, "blankblock.png")).convert()

warn1 = pygame.image.load(path.join(assets, "block1.png")).convert()
warn2 = pygame.image.load(path.join(assets, "block2.png")).convert()
warn3 = pygame.image.load(path.join(assets, "block3.png")).convert()
warn4 = pygame.image.load(path.join(assets, "block4.png")).convert()
warn5 = pygame.image.load(path.join(assets, "block5.png")).convert()
warn6 = pygame.image.load(path.join(assets, "block6.png")).convert()
warn7 = pygame.image.load(path.join(assets, "block7.png")).convert()
warn8 = pygame.image.load(path.join(assets, "block8.png")).convert()
explode = pygame.image.load(path.join(assets, "explode.png")).convert()
flag = pygame.image.load(path.join(assets, "flag.png")).convert()
question = pygame.image.load(path.join(assets, "question.png")).convert()

clock = pygame.image.load(path.join(assets, "time.png")).convert()
